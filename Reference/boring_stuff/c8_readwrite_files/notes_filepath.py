...
The path specifies the location of a file on yhe compuer.
...
# oi = os.path.relpath('/Users/', os.getcwd())
# print(oi) # ../../../../../..
# print(os.path.isabs(oi)) # False
...
# print(rejoined_path)
# /Users/Joo/Desktop/Development/Python/Reference/automate the boring stuff with Python/c8_readwrite_files/notes.py
## these are important / good syntaxes to remember around os.path.sep
